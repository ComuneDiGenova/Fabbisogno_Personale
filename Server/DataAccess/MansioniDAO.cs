...
{
  public class MansioniDAO
  {
    public List<dynamic> Read(string query)
    {

      string sql = "SELECT ID,NOME FROM PERS_MANSIONE ORDER BY NOME";
    ...
    {
      string sql = "INSERT INTO PERS_MANSIONE (NOME) VALUES(@NOME)";
      SqlCommand cmd = DbManager.CreateCommand(sql);
    ...
    {
      string sql = "UPDATE PERS_MANSIONE SET NOME = @NOME WHERE ID = @ID";
      SqlCommand cmd = DbManager.CreateCommand(sql);
    ...
    {
      string sql = "DELETE FROM PERS_MANSIONE WHERE ID = @ID";
      SqlCommand cmd = DbManager.CreateCommand(sql);
